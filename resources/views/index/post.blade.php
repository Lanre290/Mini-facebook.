                        ...
                        @if (is_file($file->path))
                            ...
                            @elseif (strpos(mime_content_type($file->path), 'video/') === 0)
                                <div class="relative h-full w-full min-h-full min-w-full video-cont"  data-interval="" onmousemove="showControl(this)">
                                    <button class="absolute top-1/2 left-1/2 right-1/2 bottom-1/2 text-gray-50 text-6xl cursor-pointer p-6 z-50" id="play-btn" style="transform: translate(-50%, -50%);" onclick="playVideo(this, event)"><i class="fa fa-play"></i></button>
